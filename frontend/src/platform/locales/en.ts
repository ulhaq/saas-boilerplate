...
export default {
  ...
  auth: {
    ...
    mfaCodeHint: 'The 6-digit code shown in your authenticator app.',
    mfaRecoveryCode: 'Recovery code',
    mfaRecoveryCodeHint:
      'One of the recovery codes you saved when enabling two-factor authentication. Each code works once.',
    mfaUseRecoveryCode: 'Use a recovery code',
    mfaUseAuthenticator: 'Use authenticator app',
    mfaVerify: 'Verify',
    mfaChallengeExpired: 'This sign-in attempt has expired. Go back and sign in again.',
    loginTitle: 'Login',
  ...
  users: {
    ...
    pendingInvitations: {
      ...
      description: 'Invites that have been sent but not accepted yet.',
      ...
      revokeDescription: 'The invitation link sent to {email} will stop working.',
      revoked: 'Invitation revoked',
      revokeFailed: 'Failed to revoke invitation',
      loadFailed: 'Failed to load pending invitations',
    },
    form: {
  ...
  settings: {
    ...
    mfa: {
      ...
      description:
        'Require a code from an authenticator app (such as 1Password, Google Authenticator or Authy) when signing in.',
      enabled: 'Enabled',
      enable: 'Enable',
      disable: 'Disable',
      confirm: 'Confirm and enable',
      stepScan: 'Scan the QR code with your authenticator app.',
      stepConfirm: 'Enter the 6-digit code it shows to confirm.',
      qrAlt: 'QR code for your authenticator app',
      manualEntry: "Can't scan? Enter this key manually:",
      disableTitle: 'Disable two-factor authentication',
      disableDescription:
        'Your account will be protected by your password only. Confirm with your password and a code.',
      regenerateCodes: 'New recovery codes',
      regenerateDescription:
        'Your existing recovery codes stop working. Enter a code from your authenticator app to continue.',
      regenerate: 'Generate',
      recoveryCodesTitle: 'Save your recovery codes',
      recoveryCodesWarning:
        "Use these if you lose access to your authenticator app. Each code works once, and they won't be shown again.",
      copy: 'Copy',
  ...
  errors: {
    ...
    api: {
      ...
      mfa_setup_required: 'Start two-factor setup again.',
    },
    fields: {
      body__name: 'Name',
      body__email: 'Email',
